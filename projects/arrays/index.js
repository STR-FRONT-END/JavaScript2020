...
(1) an array 
(2) a flavor
Your function should add the flavor to the front of the array. Invoke the function passing in the array and 'Rainbow Sherbert' as arguments
console.log the array to ensure you have done this correctly 
